...
export default async function UserGuideCurrentTournamentPage({
  ...
  const isWorker = user.is_worker;
    ...
    return <div className="rtl w-full" style={{zoom: 1.3}}>
        ...
        <div className="flex w-full items-center justify-between " style={{marginTop: 3}}>
            כאשר אתם בעמוד זה, לחיצה על ״שמור״ (ctrl+S) תוריד למחשב קובץ של נתוני הקרדיט העדכניים
        </div>

        <div className="flex w-full items-center justify-between " style={{marginTop: 7}}>
            מומלץ מדי פעם לשמור
        </div>
    </div>
}
