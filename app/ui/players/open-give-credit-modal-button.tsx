...
function SetGivePrizeForm({player, hide, prevPage} : { player: PlayerForm, hide?: ()=>void, prevPage:string}) {
    ...
    return (
      <div style={{marginRight:10}}>
          ...
          {!hasReceived && <div className={show ? 'edit-player-modal' : 'hidden'}>
              <SetGivePrizeForm player={player as unknown as PlayerForm} hide={close} prevPage={prevPage}/>
          </div>}
      </div>
  );
}
