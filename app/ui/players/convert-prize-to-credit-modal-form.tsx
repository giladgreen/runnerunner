            ...
            <form action={dispatch} className="form-control">
                ...
                <div className="rounded-md  p-4 md:p-6 form-inner-control">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mb-4 give_user_credit_amount">
    ...
    return (
        <div className="give-credit-modal-button"  style={{marginRight: 10}}>
            ...
            <div className={show ? 'edit-player-modal' : 'hidden'}>
                <ConvertPrizeToCreditModalForm  hide={close} prevPage={prevPage} prizeId={prizeId} prizeName={prizeName} userId={userId}/>
            </div>
        </div>
    );
}
