...
export async function PlayerSetupNameModal({ player }: { player: PlayerDB }) {
    ...
    const updateNewPlayerNameWithPlayerId = updateNewPlayerName.bind(null, player.id);
    // @ts-ignore
    const [state, dispatch] = useFormState(updateNewPlayerNameWithPlayerId, initialState);

    return <div className="setup-player--name-modal-inner-div">
