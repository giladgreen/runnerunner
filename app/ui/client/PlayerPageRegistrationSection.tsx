...
export default function PlayerPageRegistrationSection({
  ...
  if (todayTournaments.length < 2){
    return <SingleTournament showingTabs={false} onSubmit={onSubmit} index={0} todayTournament={todayTournaments[0]} playerCurrentTournamentHistory={playerCurrentTournamentHistory} player={player} rsvpCountsForTodayTournaments={rsvpCountsForTodayTournaments}/>
  }
          ...
          {todayTournaments.map((todayTournament, index) => {
            return (
              <TabPanel key={todayTournament.id}>
                <SingleTournament showingTabs onSubmit={onSubmit} index={index} todayTournament={todayTournament} playerCurrentTournamentHistory={playerCurrentTournamentHistory} player={player} rsvpCountsForTodayTournaments={rsvpCountsForTodayTournaments}/>
              </TabPanel>
            );
          })}
        </Tabs>
