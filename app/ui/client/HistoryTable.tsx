    ...
    <table className=" min-w-full text-gray-900 md:table">
      <thead className="rounded-lg text-left text-sm font-normal">
        <tr>
          ...
          <th scope="col" className="wide-screen px-3 py-5 font-medium">
            Updated By
          </th>
        </tr>
      </thead>
      <tbody className="bg-white">
        {historyLog?.map((log) => (
          ...
          >
            ...
            <td className="whitespace-nowrap px-1 py-2">{log.note}</td>
            ...
            <td className="wide-screen whitespace-nowrap px-3 py-3">
              {log.updated_by}
            </td>
          </tr>
        ))}
