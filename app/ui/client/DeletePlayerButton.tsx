...
export default function DeletePlayerButton({id, userId}: { userId: string, id: string }) {

    const deletePlayerWithId = deletePlayer.bind(null, {id, prevPage: `/${userId}/players/`});
