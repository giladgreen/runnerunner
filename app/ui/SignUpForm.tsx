      ...
      <form action={dispatch} className="space-y-3">
        <div className="flex-1 rounded-lg bg-gray-50 px-6 pb-4 pt-8">
          ...
          <div className="w-full">
            ...
            <div className="mt-4 regulations_approve" style={{display: 'flex'}}>
              <Checkbox inputId="regulations_approve" name="regulations_approve" value="regulations_approve"
            ...
            <div className="mt-4 marketing_approve" style={{display: 'flex'}}>
              <Checkbox inputId="marketing_approve" name="marketing_approve" value="marketing_approve"
