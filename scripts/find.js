...
async function main() {
  ...
  try {
    ...
    const players = (await client.sql`SELECT * FROM players ORDER BY name ASC;`).rows;
    for (let i=0; i< players.length-1; i++){
      ...
      if (['01004','01019','01007','01010','01034','01090','01110','01116','01123','01177','01186','01203','01232','01247','01298','01333','01354','01358','01366'].includes(playerAPhone)){
        continue;
      }
      for (let j= 0; j< players.length; j++){
        ...
        const dis = levenshteinDistance(playerA.name.replaceAll(' ',''), playerB.name.replaceAll(' ',''));
        if (dis < 3){
          console.log('## ',reverse(playerAName),playerAPhone ,', balance:',playerA.balance,' | ', reverse(playerBName), playerBPhone, ', balance:',playerB.balance);
        }
